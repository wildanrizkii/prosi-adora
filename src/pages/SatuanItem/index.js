...
import { Modal, IsiModalSuccess, IsiModalFailed } from "../../../components/TambahSatuanComp";
...
export default function SatuanItem({ hasil }) {
      ...
      return (
        ...
        >
          ...
          <td>
            ...
            {x.status === 1 ? (
              <button className="button is-danger is-small" style={{ marginLeft: "5px" }} onClick={() => changeStatus(x.id_satuan, false)}>
                Non-Aktifkan
              </button>
            ) : (
              <button className="button is-primary is-small" style={{ marginLeft: "5px" }} onClick={() => changeStatus(x.id_satuan, true)}>
                Aktifkan
              </button>
            )}
          </td>
  ...
  return (
    <>
      ...
      <Link className="button is-link" href="SatuanItem/TambahSatuan" style={{ marginBottom: "10px" }}>
        Tambah
      </Link>
