...
// export function Alamatreducer(state, action) {
//   if (action.type === "loading") {
//     return {
//       hasil: (
//         <p className="help is-info" style={{ fontSize: "15px" }}>
...
//       hasil: (
//         <p className="help is-danger" style={{ fontSize: "15px" }}>
//           nama alamat tidak memenuhi ketentuan
//         </p>
//       ),
//       warnaTextbox: "input is-danger",
//       icon: <FontAwesomeIcon icon="times" color="red" />,
...
// export const NomorhpReducer = (state, action) => {
//   if (action.type === "loading") {
//     return {
//       hasil: (
//         <p className="help is-info" style={{ fontSize: "15px" }}>
...
//       hasil: (
//         <p className="help is-danger" style={{ fontSize: "15px" }}>
//           nama nomor HP tidak memenuhi ketentuan
//         </p>
//       ),
//       warnaTextbox: "input is-danger",
//       icon: <FontAwesomeIcon icon="times" color="red" />,
...
// export function NomorHP({ className, value, onChange, icon, hasil }) {
//   return (
//     <div className="field">
...
// export function Kota({ onChange, value }) {
//   return (
//     <div className="field">
